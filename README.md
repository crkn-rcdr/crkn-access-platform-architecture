#  Discovery Platform Infrastructure

This document provides an overview of the core service environments within the Discovery Platform (Canadiana, Heritage, Parl, GAC, NRCan), including Docker service containers and associated Solr/Swift data stores.
...
| [IIIF Presentation](https://github.com/crkn-rcdr/crkn-IIIF-presentation-api) | iiif-p-canadiana | Swift container: iiif_pres_canadiana |
...
| IIIF Presentation | iiif-p-heritage | Swift container: iiif_pres_heritage |
...
| IIIF Presentation | iiif-p-parl | Swift container: iiif_pres_parl |
...
| IIIF Presentation | iiif-p-gac | Swift container: iiif_pres_gac |
...
| IIIF Presentation | iiif-p-nrcan | Swift container: iiif_pres_nrcan |
